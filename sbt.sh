...
${DIR_CODE}/python 5S.py $bam ${SAMPLE}.5S.fastq
...
bowtie2  -x ${DIR_CODE}/../db.human/rDNA --end-to-end -D 15 -R 2 -L 22 -i S,1,1.15 ${SAMPLE}.cat.rDNA.fastq | /u/home/s/serghei/collab/code/rop.old/tools/samtools view -F 4 -bh - | /u/home/s/serghei/colab/code/rop.old/tools/samtools sort - >${sample}.sort.rDNA.bam
...
$samtools view -bh $bam MT | $samtools samtools fastq - >${SAMPLE}.MT.fastq
