...
$megahit -r ${SAMPLE}.sort.repeat.fastq -o ${SAMPLE}.repeat.megahit --out-prefix repeat.megahit
...
$megahit -r ${SAMPLE}.cat.unmapped.fastq -o ${SAMPLE}.unmapped.megahit --out-prefix unmapped.megahit
...
${DIR_CODE}/megahit/megahit -r ${SAMPLE}.sort.rDNA.fastq -o ${SAMPLE}.rDNA.megahit --out-prefix rDNA.megahit
...
$megahit -r ${SAMPLE}.cat.MT.fastq -o ${SAMPLE}.MT.megahit --out-prefix MT.megahit
...
$megahit-r ${SAMPLE}.sort.MT.fastq -o ${SAMPLE}.MT.megahit --out-prefix MT.megahit
...
bowtie2  -x ${DIR_CODE}/db.human/IMGT/receptor.genes -D 15 -R 2 -L 22 -i S,1,1.15 ${SAMPLE}.cat.ireceptor.fastq | $samtools view -F 4 -bh - | $samtools sort - >${SAMPLE}.sort.ireceptor.bam

$samtools index ${SAMPLE}.sort.ireceptor.bam

$samtools fastq ${SAMPLE}.sort.ireceptor.bam >${SAMPLE}.sort.VDJ.fastq
$megahit --k-min 51 --k-step 10 -r ${SAMPLE}.sort.VDJ.fastq -o ${SAMPLE}.VDJ.megahit --out-prefix VDJ.megahit
...
~/collab/code/rop/tools/metaphlan2/metaphlan2.py ${SAMPLE}.unmapped.fastq --nproc 8 --input_type fastq --bowtie2out ${SAMPLE}.metaphlan2.bowtie2.txt >${SAMPLE}.metaphlan2.txt



imrep=~/collab/code/imrep/imrep.py
